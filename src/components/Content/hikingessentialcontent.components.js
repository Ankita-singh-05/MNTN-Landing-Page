...
const HikingEssentials = () => {
  return (
    <>
      <div className="content-main-container flex p-12 gap-4">
        ...
        <div className="content1-content">
          ...
          <h1 className="text-[#fff] font-semibold text-[64px] font-[Chronicle Display] w-[10em] content-heading ">Picking the right Hiking Gear!</h1>
